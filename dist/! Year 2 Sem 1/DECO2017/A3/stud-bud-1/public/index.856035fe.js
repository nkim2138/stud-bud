...
function renderTask(task1) {
     ...
     <ul class = "newTaskCreated">
        <li class = "taskDetails" >
            <nav class = "unit-priority">
                 <p class="createdUnitOfStudy">${task1.unitofstudy}<p>
                 <p class="createdPriority">${task1.priority}<p>
            </nav>
        </li>

        <li class = "taskDetails">
            <p class="createdTaskName">${task1.name}<p>
        </li>

        <li class = "taskDetails">
            <p class="createdTaskDescription">${task1.description}<p>
        </li>
        ...
        <li class = "taskDetails">
            <nav class = "dateAndTime">
                <div class = "due">
                    <p class="createdDueDate">${task1.dueDate} | <p>
                    <p class="createdCompletionTime"> ${task1.completionTime}<p>
                </div>
                <div class = "estimate">
                    <p class="createdEstimatedTime">${task1.estimatedTime}min <p>
                </div>
            </nav>
        </li>
    ...
    task1.description = task1.description.substring(0, 30) + "...";
