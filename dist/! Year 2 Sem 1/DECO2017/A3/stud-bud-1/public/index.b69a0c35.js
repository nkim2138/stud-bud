...
startBtn.addEventListener("click", ()=>{
    ...
    if (btn === "focus") mins = +localStorage.getItem("focusTime") || 25;
    else mins = +localStorage.getItem("breakTime") || 5;
...
function decremenT() {
    ...
    if (circle.classList.contains("almostDone")) circle.classList.remove("almostDone");
    if (secs > 0) {
        ...
        if (secs < 10) circle.classList.add("almostDone");
    } else {
        mins = 0;
        secs = 0;
        // bell.play();
...
//# sourceMappingURL=resources.b69a0c35.js.map
